...
async function run() {
  try {
    ...
    const taskDefinitionFamilyOverride =
      core.getInput("task-definition-family-override", { required: false }) ||
      undefined;
    ...
    if (taskDefinitionFamilyOverride) {
      taskDefContents.family = taskDefinitionFamilyOverride;
    }
