...
describe("Render task definition", () => {
  ...
  test("replaces taskDefinitionFamily when specified and reading from file", async () => {
    core.getInput = jest
      .fn()
      .mockReturnValueOnce("task-definition-with-task-family.json") // task-definition
      .mockReturnValueOnce("web") // container-name
      .mockReturnValueOnce("some-other-image") // image
      .mockReturnValueOnce("") // environment-variables
      .mockReturnValueOnce("") // env-files
      .mockReturnValueOnce("") // log Configuration Log Driver
      .mockReturnValueOnce("") // log Configuration Options
      ...
      .mockReturnValueOnce("") // task-definition revision
      .mockReturnValueOnce("") // secrets
      .mockReturnValueOnce("new-task-definition-family"); // task-definition family overridee

    jest.mock(
      "./task-definition-with-task-family.json",
      () => ({
        family: "task-def-family",
        containerDefinitions: [
          {
    ...
    expect(fs.writeFileSync).toHaveBeenNthCalledWith(
      ...
      JSON.stringify(
        {
          family: "new-task-definition-family",
          containerDefinitions: [
            {
              name: "web",
              image: "some-other-image",
